...
export default function Header({ docs }) {
    return (
        ...
        >
            <Logo />
            <div
                className="fixed inset-x-0 top-0 z-50 bg-white/50 px-4 backdrop-blur-sm transition dark:bg-[#17181C] dark:backdrop-blur sm:px-6 lg:left-72 lg:z-30 lg:px-8 xl:left-80"
            >
